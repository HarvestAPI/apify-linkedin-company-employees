## LinkedIn Company Employees Mass scraper
...
If you need to scrape large volumes (200,000+ profiles in several hours), the actor might possibly hit rate LinkedIn's rate limits.
...
## Linkedin Company Employees Search API
